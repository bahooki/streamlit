...
Xiang = st.sidebar.button("Introduction - Xiang")
Jerry = st.sidebar.button("Databases Collection - Jerry")
Kristen = st.sidebar.button("Plotly Library - Kristen")
Leah = st.sidebar.button("Altair Library - Leah")
Nash = st.sidebar.button("PyDeck Library- Nash")
Stian = st.sidebar.button("Matplotlib - Stian")
Q_A = st.sidebar.button("Q & A")
